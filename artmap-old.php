...
// Layer "markers"
  ...
  var content = '<a href="http://' + lang + '.wikivoyage.org/wiki/';
  for (var i = 0; i < nr; i++) {
    var a = addressPoints[i];
    markers.addLayer(new L.Marker(new L.LatLng(a[0],a[1]),{title: a[2]}).bindPopup(content+a[2]+'">'+a[2]+'</a>'));
  }
