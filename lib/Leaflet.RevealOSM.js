L.Control.RevealOSM = L.Control.extend({
    ...
    options: {
        ...
        helpText: "Click on <b>Mapnik</b> icons to get more infos",
    ...
    formatContent: function (element) {
        ...
        content = title + '<ul>' + content +  '<br/>' + '{{ <i style="background-color:#FFCCCC">type</i> | name=' + element.tags.name + ' | address= | lat=' + reflat + ' | long=' + reflng + ' | phone=' + element.tags.phone + ' | hours=' + element.tags.opening_hours + ' }}</ul>';
