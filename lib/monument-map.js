...
function showMap(lat, long, zoom, monumentsData) {
    var autozoom = "no";
    if (zoom === "auto") {
        autozoom = "yes";
    }
    ...
    $.each(monumentsData, function (_, monument) {
