...
*
* modificaions in lines 20-25 (Special icon) 46 (zoom level) and  126 (red icon)
*/
...
L.Control.GeoSearch = L.Control.extend({
    ...
    _showLocation: function (location) {
        if (typeof this._positionMarker === 'undefined')
            this._positionMarker = L.marker([location.Y, location.X],{icon: redIcon}).addTo(this._map);
        else
