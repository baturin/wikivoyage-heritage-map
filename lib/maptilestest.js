...
function maptiles() {
  ...
  mapnik = new L.TileLayer(tilesUrl, {attribution: tilesAttrib, subdomains: subDomains}); 
  ...
  // "Boundaries"
  tilesUrl = 'http://openmapsurfer.uni-hd.de/tiles/adminb/tms_b.ashx?x={x}&y={y}&z={z}';
  tilesAttrib = '';
